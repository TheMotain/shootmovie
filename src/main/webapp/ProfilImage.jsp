					...
					<div class="col-md-6">
						<form method="post" class="form-horizontal"
							...
							<div class="form-group">
								...
								<div class="col-sm-11">
									<input type="text" class="form-control" name="avatar"><br>
									<input type="submit" class="btn btn-default btn-block" value="Modifier">
								</div>
							</div>
						</form>
					</div>
					<div class="col-md-6">
						<form method="post" class="form-horizontal"
							...
							<div class="form-group">
								...
								<div class="col-sm-11">
									<input type="text" class="form-control" name="baniere"><br>
									<input type="submit" class="btn btn-default btn-block" value="Modifier">
								</div>
							</div>
						</form>
