...
<html lang="fr">
	<head>
		<title>ShootFilm - Titre de la vid�o</title>
		<meta charset='utf-8'>
		<!-- jQuery -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#">Vid�os</a></li>
      </ul>
					...
					%>
					  <div class="commentaire-box">
					  	<div class="row">
					  		...
					  		<div class="col-md-10">
					  			<span class="commentaire-date">Post� le <%
					  			out.print(tmp2[2]+" � "+tmp2[3]); %></span><br>
					  			<p><%
					  			out.print(tmp2[1]); %></p>
					  		</div>
					  	</div>
					  ...
					  <!-- Fin de r�p�tition -->
					  	...
					  	out.print(request.getParameter("id"));%>" method="post" class="form-horizontal">
					    	<textarea id="textarea" rows="5" class="form-control" placeholder="Commentez la vid�o ..." name="comm"></textarea><br>
