...
public interface ProfilDao {
	...
	public void insertProfil(@Bind("id") int id, @Bind("id_utilisateur") int id_utilisateur, @Bind("lien_background") String lien_background,
			@Bind("lien_avatar") String lien_avatar);
